...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\gagee\\Bootcamp\\Project2\\SocialGoalsTracker\\social-goals-tracker\\src\\main\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
path.join(process.cwd(), "src/main/prisma/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/main/prisma/schema.prisma")
